...
use App\Http\Requests\CreateDeparmentRequest;
...
class DepartmentController extends Controller
{
     ...
     */
    public function store(CreateDeparmentRequest $request)
    {
     ...
     */
    public function update(CreateDeparmentRequest $request, Department $department)
    {
